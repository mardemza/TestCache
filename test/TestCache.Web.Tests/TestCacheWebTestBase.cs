...
{
    public abstract class TestCacheWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TestCacheWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TestCacheWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TestCacheDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TestCacheDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TestCacheDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TestCacheDbContext, Task<T>> func)
        {
            T result;
